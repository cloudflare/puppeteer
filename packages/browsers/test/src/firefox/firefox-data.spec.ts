...
describe('Firefox', () => {
  it('should resolve download URLs', () => {
    ...
    assert.strictEqual(
      ...
      'https://archive.mozilla.org/pub/firefox/nightly/2023/08/2023-08-01-03-45-57-mozilla-central/firefox-111.0a1.en-US.mac.dmg'
    );
    assert.strictEqual(
    ...
    assert.strictEqual(
      ...
      'https://archive.mozilla.org/pub/firefox/nightly/2023/08/2023-08-01-03-45-57-mozilla-central/firefox-111.0a1.en-US.win32.zip'
    );
    assert.strictEqual(
